...
a2 = [ones(size(a2, 1), 1), a2]; % with bias
z3 = a2 * Theta2';
a3 = sigmoid(z3); %results

%generate matrix of vectors from labels
...
R = lambda/(2*m) * (sum(sumsq(Theta1NoBias)) + sum(sumsq(Theta2NoBias)));

%cost with regularization
J = J + R;
% -------------------------------------------------------------
%backpropogation - calculate delta_1, delta_2
Delta1 = 0;
Delta2 = 0;
